...
router.post('/login', withAuthentication(), userController.loginUser);
router.put('/changePassword', withAuthentication(), authController, userController.changePassword);
router.post('/setPassword', withAuthentication(), userController.validateUser);
router.put('/forgetPassword', withAuthentication(), userController.forgetPassword);
...
router.put('/', authController, withAuthentication(), userController.updateUserProfile);
...
router.post('/emailChange', withAuthentication(), userController.changeRegisteredEmail);
router.post('/checkLinkValid', withAuthentication(), userController.checkLinkValid);
