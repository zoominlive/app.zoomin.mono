module.exports = {
  ...
  USER_REGISTERED: "Registration successful, invitation email sent",
  ...
  ZONES_ADDED: "Zones added to child.",
  CHILD_ZONE_DELETED: "Zone deleted for child.",
  ZONE_SCHEDULER_CHANGED: "Zone access schedule changed.",
  ...
  LIVE_STREAM_ZONE_NOT_ALLOWED: "Only one active stream per zone license is available.",
