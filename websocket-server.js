...
let wss;
// Store active connections at module level
const connections = new Map();

// Function to initialize WebSocket server with HTTP server
const initializeWebSocket = (server) => {
  wss = new WebSocket.Server({ 
    server: server,  // Attach to HTTP server
    path: '/websocket'  // Add specific path for WebSocket connections
  });

  console.log(`WebSocket server attached to HTTP server with path /websocket`);
